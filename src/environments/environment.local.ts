...
const mmuUI_IP = 'http://localhost';
const schedulerUI_IP = 'http://localhost';
const inventoryUI_IP = 'http://localhost';
const identityIP = 'http://localhost';

const SERVER_IP = 'http://localhost';
const SWYMED_IP = 'http://localhost';
