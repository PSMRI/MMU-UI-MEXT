  ...
  implements OnInit, DoCheck, OnChanges, OnDestroy
{
  ...
  resetOtherPregnancyComplication(
    ...
    if (pregComplicationList.length > 1) {
      ...
      const t =
        pregComplicationList[0].pregComplicationType === 'None' ||
        pregComplicationList[0].pregComplicationType === 'Nil'
          ? false
          : true;
      this.complicationOptionConstraints[
        index
  ...
  resetOtherDeliveryComplication(pastObstericHistoryForm: any, index: any) {
    ...
    if (deliveryComplicationList.length > 1) {
      ...
      const t =
        ...
        deliveryComplicationList[0].deliveryComplicationType === 'Nil'
          ? false
          : true;
      this.complicationOptionConstraints[
        index
  ...
  resetOtherPostpartumComplicationType(
    ...
    if (postpartumComplicationList.length > 1) {
      ...
      const t =
        ...
        postpartumComplicationList[0].postpartumComplicationType === 'Nil'
          ? false
          : true;
      this.complicationOptionConstraints[
        index
  ...
  resetPostComplicationType(pastObstericHistoryForm: any, index: any) {
    ...
    if (postpartumComplicationList.length > 1) {
      ...
      const t =
        ...
        postpartumComplicationList[0].complicationValue === 'Nil'
          ? false
          : true;
